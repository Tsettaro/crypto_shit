...
// HELPER: RSA Decrypt AES Key
std::vector<unsigned char> rsa_decrypt_aes_key(const std::vector<unsigned char>& encrypted_key, EVP_PKEY* priv_key) {
...
void hybrid_encrypt(const std::string& input_path, const std::string& output_path, const std::string& pub_key_path) {
    ...
    std::vector<unsigned char> encrypted_key = rsa_encrypt_aes_key(aes_key, pub_key.get());
...
void hybrid_decrypt(const std::string& input_path, const std::string& output_path, const std::string& priv_key_path) {
    ...
    std::vector<unsigned char> aes_key = rsa_decrypt_aes_key(encrypted_key, priv_key.get());
